	...
	public void addChunk()
	{
		switch (numChunks)
		{
			case 0:
				...
				break;
			case 1:
				chunks[numChunks++] = new Line2D.Double(xLoc + size/2, yLoc + size, 
														xLoc + size/2, yLoc + 2*size);
				break;
			case 2:
				chunks[numChunks++] = new Line2D.Double(xLoc + size/2, yLoc + 3*size/2,
														xLoc, yLoc + size);
				break;
			case 3:
				chunks[numChunks++] = new Line2D.Double(xLoc + size/2, yLoc + 3*size/2,
				...
				break;
			case 4:
				chunks[numChunks++] = new Line2D.Double(xLoc + size/2, yLoc + 2*size,
														xLoc, yLoc + 3*size);
				break;
			case 5:
				chunks[numChunks++] = new Line2D.Double(xLoc + size/2, yLoc + 2*size,
														xLoc + size, yLoc + 3*size);
				break;
			case 6:
				chunks[numChunks++] = new Ellipse2D.Double(xLoc + size / 4, yLoc + 3*size/5,
															size/2, size/4);
				break;
		}
	}
